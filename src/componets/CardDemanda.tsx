...
import { Card, CardHeader, CardContent, Box, Typography, Button, Checkbox } from "@mui/material";
import StatusDemanda from "./StatusDemanda";
import { useState } from "react";
import DetalhesDemandaModal from "./DetalhesDemandaModal";

// Adicionamos as props de seleção ao Card
...
export default function CardDemanda(props: CardDemandaProps) {
    ...
    return (
        <div>
            <Card sx={{ width: 400, height: 500, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', border: isSelected ? '2px solid #1976d2' : 'none' }}>
                <Box>
                    <CardHeader 
                        action={
                ...
                <CardContent>
                    ...
                    <Button variant="outlined" size="small" onClick={() => setModalOpen(true)} sx={{ mt: 1 }}>
                        Detalhes
                    </Button>
                </CardContent>
            </Card>
