...
export function useFormularioBuilder() {
    ...
    const addField = useCallback((tipo: CampoTipo) => {
        ...
        switch (tipo) {
            ...
            case 'number': novoCampo = { ...base, type: 'number', placeholder: '0' }; break;
            case 'date': novoCampo = { ...base, type: 'date' }; break;
            ...
            case 'select': case 'radio': case 'checkbox_group':
                novoCampo = {
                    ...base,
                    type: tipo as any,
                ...
                break;
            case 'header': novoCampo = { ...base, type: 'header', label: 'Novo Título de Seção' }; break;
            case 'separator': novoCampo = { ...base, type: 'separator', label: 'Separador' }; break;
            case 'tree_species': novoCampo = { ...base, type: 'tree_species', label: 'Espécie da Árvore' }; break;
            case 'file': novoCampo = { ...base, type: 'file', max_files: 1 }; break;
            default: return;
        }
